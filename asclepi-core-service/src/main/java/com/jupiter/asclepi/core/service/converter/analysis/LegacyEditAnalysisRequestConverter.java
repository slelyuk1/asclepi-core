...
public class LegacyEditAnalysisRequestConverter implements Converter<EditAnalysisRequest, Analysis> {
    ...
    public Analysis convert(EditAnalysisRequest source) {
        ...
        AnalysisId analysisId = new AnalysisId(visitId, analysisGetter.getNumber());
