...
@Transactional
@SpringBootTest
public class HistoryControllerBusinessTest extends AbstractHistoryTest {

    private MockMvc mockMvc;

    @Autowired
    public HistoryControllerBusinessTest(ObjectMapper objectMapper, EntityManager entityManager) {
